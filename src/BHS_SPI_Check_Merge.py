...
tracker=r"\01_CE\BHS\Tools\BHS_Consolidated_Dataset_Tracking.xlsx"
consolidated_gdb=r"\01_CE\BHS\BHS_Scratch\BHS_Test_3.gdb"
...
def update_fc_from_spi(exsitng_gdb):
    ...
    for key in fc_dict:
        ...
        if feats>0:
            ...
            xlsx_append=[today, fc_name, feats, "Comming soon", username]
            logging.debug(xlsx_append)
