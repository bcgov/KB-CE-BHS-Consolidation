            ...
            if fc is not None:
                ...
                if before_1998_count >0:
                    ...
                    if final_count >0:                
                        ...
                        self.tracker.append_tracker(winter_pre_name,int(final_count), str(feature_list[fc]), str(usr_nm))
                    ...
                    if final_count >0:                     
                        ...
                        fieldMappings.removeAll()
                        self.tracker.append_tracker(winter_post_name,int(final_count), str(feature_list[fc]), str(usr_nm))
                    ...
                    if final_count >0: 
                        ...
                        fieldMappings.removeAll()
                        self.tracker.append_tracker(movement_pre_name,int(final_count), str(feature_list[fc]), str(usr_nm))
                    ...
                    if final_count >0: 
                        ...
                        fieldMappings.removeAll()
                        self.tracker.append_tracker(movement_post_name,int(final_count), str(feature_list[fc]), str(usr_nm))
                    ...
                    if final_count >0:
                        ...
                        arcpy.management.Append(key, winter_post_name, schema_type= "NO_TEST", field_mapping=fieldMappings, expression=winter_post) 
                        fieldMappings.removeAll()
                        self.tracker.append_tracker(str(winter_pre_name),(final_count), str(feature_list[fc]), str(usr_nm))      
